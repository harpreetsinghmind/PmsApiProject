...
/****** Object:  StoredProcedure [dbo].[usp_SalesPersonInsert]    Script Date: 4/30/2019 11:19:41 AM ******/
SET ANSI_NULLS ON
GO
...
AS 
	...
	BEGIN TRAN
	IF NOT EXISTS(select * from SalesPerson where lower(WorkEmail) = LOWER(@WorkEmail))
	BEGIN
		IF NOT EXISTS(select * from SalesPerson where MobileNo = @MobileNo)
		BEGIN
